...
public class validatePBUserName extends Base//driver declare in base class
{
	...
	public void launchPolicyBazaar() throws InterruptedException, IOException
	{
		...
		launchBrowser();//base class method launchBrowser
  ...
  public void validateUN() throws IOException, InterruptedException 
  {
	  ...
	  String expectedUN = Utility.readDataFromExcel(0, 2); 
